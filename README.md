...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/traviscli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14414&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/traviscli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `traviscli` can be installed with:

```
conda install traviscli
```

It is possible to list all of the versions of `traviscli` available on your platform with:
